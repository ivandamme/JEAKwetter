...
public class DAOCollectionImplTest {
    ...
    public void testCreateUser() throws Exception {
        Location location = new Location(1,1,"Venlo");
        Role role = new Role("Moderater");
        User user = new User("Niek","TEST","Hello im Niek",location,"www.niek.nl","https://hekwerk.nl/media/images/artists/thumbnails/pieterderks-pas-640x_.jpg");
        userDAOCollectionImpl.createUser(user);
    ...
    public void testGetAllUser() throws Exception {
        Location location = new Location(1,1,"Venlo");
        Role role = new Role("Moderater");
        User user1 = new User("Niek","TEST","Hello im Niek",location,"www.niek.nl","https://hekwerk.nl/media/images/artists/thumbnails/pieterderks-pas-640x_.jpg");
        userDAOCollectionImpl.createUser(user1);
        assertEquals(2, userDAOCollectionImpl.getAllUsers().size());
        User user2 = new User("Piet","TEST","Hello im Piet",location,"www.piet.nl","https://hekwerk.nl/media/images/artists/thumbnails/pieterderks-pas-640x_.jpg");
